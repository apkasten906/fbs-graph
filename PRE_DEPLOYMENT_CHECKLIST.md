...
- [ ] Updated `web/fbs-graph-timeline-explorer.html` (static data support)
- [ ] Updated `web/fbs-graph-visualizer.html` (static data support)
- [ ] Updated `web/modules/fbs-graph-timeline-explorer.js` (static data support)
